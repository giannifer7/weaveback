...
Weaveback exposes a small set of operations via MCP:

- trace a generated line to its source
- retrieve full chunk context (code, prose, dependencies)
...
*Installer script* (Linux, macOS, Windows — handles binary + asciidoctor + rouge):
