...
* link:../crates/wb-tangle/src/main.adoc[`wb-tangle`] for tangling and
  apply-back
* link:../crates/wb-query/src/main.adoc[`wb-query`] for attribution, search,
  coverage, cargo diagnostics, tagging, and LSP queries
* link:../crates/wb-serve/src/main.adoc[`wb-serve`] for the local docs server
* link:../crates/wb-mcp/src/main.adoc[`wb-mcp`] for MCP / agent integration

The role of `cli-spec/` is now narrower and easier to read, but it is still
fully generative:

1. link:macros.adoc[`macros.adoc`] defines shared option-family macros
