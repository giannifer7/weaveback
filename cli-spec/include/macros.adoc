...
rust_type = Vec<String>,
arg_attr = %{ %},
doc_block = %{        /// Optional list of files or directories to tangle. If omitted, tangles all configured passes.%},
doc_flag = %{`<FILES>...`%},
doc_default = %{ %},
doc_descr = %{Files or directories to tangle (filters the global graph). If omitted, tangles everything.%}
)
%emit_option(
field = config,
