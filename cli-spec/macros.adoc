...
[source]
----
%redef(render_rust_struct_option, field, rust_type, arg_attr, doc_block, doc_flag, doc_default, doc_descr, %{%(doc_block)
%if(%(arg_attr), %{    #[arg(%(arg_attr))]
%})
    pub(crate) %(field): %(rust_type),
%})

%redef(render_rust_enum_option, field, rust_type, arg_attr, doc_block, doc_flag, doc_default, doc_descr, %{%(doc_block)
%if(%(arg_attr), %{    #[arg(%(arg_attr))]
%})
    %(field): %(rust_type),
%})

%redef(render_rust_struct_chunk_option, field, rust_type, arg_attr, doc_block, doc_flag, doc_default, doc_descr, %{// <<%(chunk_name)>>=
%render_rust_struct_option(field=%(field), rust_type=%(rust_type), arg_attr=%(arg_attr), doc_block=%(doc_block), doc_flag=%(doc_flag), doc_default=%(doc_default), doc_descr=%(doc_descr))// @
%})

%redef(render_rust_enum_chunk_option, field, rust_type, arg_attr, doc_block, doc_flag, doc_default, doc_descr, %{// <<%(chunk_name)>>=
%render_rust_enum_option(field=%(field), rust_type=%(rust_type), arg_attr=%(arg_attr), doc_block=%(doc_block), doc_flag=%(doc_flag), doc_default=%(doc_default), doc_descr=%(doc_descr))// @
%})

%redef(render_doc_option, field, rust_type, arg_attr, doc_block, doc_flag, doc_default, doc_descr, %{| %(doc_flag) | %(doc_default) | %(doc_descr)
%})

%redef(render_doc_chunk_option, field, rust_type, arg_attr, doc_block, doc_flag, doc_default, doc_descr, %{// <<%(chunk_name)>>=
%render_doc_option(field=%(field), rust_type=%(rust_type), arg_attr=%(arg_attr), doc_block=%(doc_block), doc_flag=%(doc_flag), doc_default=%(doc_default), doc_descr=%(doc_descr))// @
%})
----
...
%redef(apply_back_command_options, %{
%emit_option(
field = files,
rust_type = Vec<String>,
arg_attr =,
...
%redef(attribute_command_options, %{
%emit_option(
field = scan_stdin,
rust_type = bool,
arg_attr = %{long%},
...
%redef(coverage_command_options, %{
%emit_option(
field = summary,
rust_type = bool,
arg_attr = %{long%},
