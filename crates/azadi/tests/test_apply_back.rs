// crates/azadi/tests/test_apply_back.rs
//
...
//
// Exercises:
//   - `azadi trace --col` differentiating MacroBody / MacroArg / VarBinding
...
//   - `azadi apply-back` propagating a gen-file edit back to a literal source line
...
/// Build `driver.md` from `DRIVER`, run azadi, return the canonicalized temp root.
...
/// Run `azadi trace <file> <line> [--col <col>]` and return parsed JSON.
...
// ── azadi trace --col: MacroBody with def_locations ──────────────────────────
...
/// the generated `header.nim`.  `azadi apply-back` must propagate the edit
