...
`PathResolver` provides a single, unified logic for normalizing paths across the 
entire toolchain. It handles absolute paths, relative paths from the project 
root, and workspace-specific prefixes like `crates/`.
