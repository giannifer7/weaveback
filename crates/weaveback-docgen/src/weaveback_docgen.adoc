...
See link:../src-wvb/render.wvb[render.wvb] for acdc rendering,
link:../src-wvb/xref.wvb[xref.wvb] for the xref graph builder,
link:../src-wvb/inject.wvb[inject.wvb] for HTML post-processing, and
link:../src-wvb/literate_index.wvb[literate_index.wvb] for literate source index
