...
*   **Source Tracing**: The DB stores the exact file and line number for every fragment of text. This allows `weaveback trace` to work even through complex nested expansions.
...
*   **Macro Power**: This allows you to use logic (Rhai/Python) to generate code chunks dynamically.
