...
check and treats the current literate source as authoritative.  This is
intended for deliberate recovery workflows such as "retangle the generated tree
from source even though some generated files drifted locally", not for normal
interactive use.
