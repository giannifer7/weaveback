...
That means the project should make these questions answerable by deterministic
tooling:
...
That is the path by which weaveback is more likely to be a help than a burden
