...
* undefined variable lookup still expands to empty
* unbound formal parameters still default to empty
* `%equal` still exists as a legacy non-canonical predicate
