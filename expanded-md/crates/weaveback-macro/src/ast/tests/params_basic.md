---
title: |-
  Basic Parameter Analysis Tests
description: |-
  Literate source for crates/weaveback-macro/src/ast/tests/params_basic.rs
toc: left
toclevels: 3
---
# Basic Parameter Analysis Tests
...
```rust
// <[@file weaveback-macro/src/ast/tests/params_basic.rs]>=
// weaveback-macro/src/ast/tests/params_basic.rs
