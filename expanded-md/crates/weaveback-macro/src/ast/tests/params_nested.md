---
title: |-
  Nested Parameter Analysis Tests
description: |-
  Literate source for crates/weaveback-macro/src/ast/tests/params_nested.rs
toc: left
toclevels: 3
---
# Nested Parameter Analysis Tests
...
```rust
// <[@file weaveback-macro/src/ast/tests/params_nested.rs]>=
