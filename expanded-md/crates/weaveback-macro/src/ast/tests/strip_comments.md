---
title: |-
  Comment Whitespace Stripping Tests
description: |-
  Literate source for crates/weaveback-macro/src/ast/tests/strip_comments.rs
toc: left
toclevels: 3
---
# Comment Whitespace Stripping Tests
...
```rust
// <[@file weaveback-macro/src/ast/tests/strip_comments.rs]>=
