...
```rust
// <[@file weaveback-macro/src/evaluator/builtins/util.rs]>=
...
```rust
// <[@file weaveback-macro/src/evaluator/builtins/definition.rs]>=
...
```rust
// <[@file weaveback-macro/src/evaluator/builtins/include.rs]>=
...
```rust
// <[@file weaveback-macro/src/evaluator/builtins/control.rs]>=
...
```rust
// <[@file weaveback-macro/src/evaluator/builtins/scope.rs]>=
...
```rust
// <[@file weaveback-macro/src/evaluator/builtins/strings.rs]>=
...
```rust
// <[@file weaveback-macro/src/evaluator/builtins/stores.rs]>=
...
```rust
// <[@file weaveback-macro/src/evaluator/builtins/predicates.rs]>=
