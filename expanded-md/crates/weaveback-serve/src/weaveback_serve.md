...
```rust
// <[@file weaveback-serve/src/server/ai/context.rs]>=
...
```rust
// <[@file weaveback-serve/src/server/ai/stream.rs]>=
...
```rust
// <[@file weaveback-serve/src/server/ai/backends.rs]>=
...
```rust
// <[@file weaveback-serve/src/server/ai/handler.rs]>=
