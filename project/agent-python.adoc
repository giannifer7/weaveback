...
This page is an architecture note. It explains the design and shows
representative code excerpts, but it does not assemble files.

The canonical literate sources live with the crates they explain:

* `weaveback-agent-core`
  - link:../crates/weaveback-agent-core/src-wvb/lib.wvb[lib.wvb]
  - link:../crates/weaveback-agent-core/src-wvb/workspace.wvb[workspace.wvb]
  - link:../crates/weaveback-agent-core/src-wvb/read_api.wvb[read_api.wvb]
  - link:../crates/weaveback-agent-core/src-wvb/change_plan.wvb[change_plan.wvb]
  - link:../crates/weaveback-agent-core/src-wvb/apply.wvb[apply.wvb]
* `weaveback-py`
  - link:../crates/weaveback-py/src/lib.adoc[lib.adoc]
