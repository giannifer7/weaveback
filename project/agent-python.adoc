...
* `weaveback-agent-core`
  ...
  - link:../crates/weaveback-agent-core/src/workspace.adoc[workspace.adoc]
  - link:../crates/weaveback-agent-core/src/read_api.adoc[read_api.adoc]
  - link:../crates/weaveback-agent-core/src-wvb/change_plan.wvb[change_plan.wvb]
  - link:../crates/weaveback-agent-core/src/apply.adoc[apply.adoc]
* `weaveback-py`
